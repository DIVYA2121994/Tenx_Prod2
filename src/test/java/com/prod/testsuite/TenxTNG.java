...
public class TenxTNG extends BaseClass
{
   ...
   @BeforeSuite
	...
	public void efc_pharmacy_prod() throws InterruptedException
	{
		...
		PageFactory.initElements(driver, TenxPO.class);
		type(driver, TenxPO.usernamefield, efc_userid);
		type(driver, TenxPO.passwordfield, efc_pwd);
		test.log(Status.INFO, "Test In Progress!!");
		click(driver, TenxPO.login);
		String loginurl = driver.getCurrentUrl();
		Boolean success = loginurl.contains("Dashboard");
		Assert.assertTrue(success);
		Thread.sleep(1000);
		click(driver, TenxPO.logout);
	...
	public void efc_admin_prod() throws InterruptedException
	{
		...
		PageFactory.initElements(driver, TenxPO.class);
		type(driver, TenxPO.usernamefield, efc_ad_uid);
		type(driver, TenxPO.passwordfield, efc_ad_pwd);
		click(driver, TenxPO.login);
		String loginurl = driver.getCurrentUrl();
	...
	public void gt_pharmacy_prod() throws InterruptedException 
	  {
			...
			PageFactory.initElements(driver, TenxPO.class);
			type(driver, TenxPO.usernamefield, gt_pharm_uid);
			type(driver, TenxPO.passwordfield, gt_pharm_pwd);
			click(driver, TenxPO.login);
			String loginurl = driver.getCurrentUrl();
			Boolean success = loginurl.contains("Dashboard");
			Assert.assertTrue(success);
	  ...
	  public void gt_admin_prod() throws InterruptedException 
	  {
			...
			PageFactory.initElements(driver, TenxPO.class);
			type(driver, TenxPO.usernamefield, gt_admin_uid);
			type(driver, TenxPO.passwordfield, gt_admin_pwd);
			click(driver, TenxPO.login);
			String loginurl = driver.getCurrentUrl();
			Boolean success = loginurl.contains("MyProfile");
			Assert.assertTrue(success);
	  ...
	  public void hn_pharmacy_prod() throws InterruptedException 
	  {
			...
			PageFactory.initElements(driver, TenxPO.class);
			type(driver, TenxPO.usernamefield, hn_pharm_uid);
			type(driver, TenxPO.passwordfield, hn_pharm_pwd);
			click(driver, TenxPO.login);
			String loginurl = driver.getCurrentUrl();
			Boolean success = loginurl.contains("Dashboard");
			Assert.assertTrue(success);
	  ...
	  public void hn_admin_prod() throws InterruptedException 
	  {
			...
			PageFactory.initElements(driver, TenxPO.class);
			type(driver, TenxPO.usernamefield, hn_admin_uid);
			type(driver, TenxPO.passwordfield, hn_admin_pwd);
			click(driver, TenxPO.login);
			String loginurl = driver.getCurrentUrl();
			Boolean success = loginurl.contains("MyProfile");
			Assert.assertTrue(success);
